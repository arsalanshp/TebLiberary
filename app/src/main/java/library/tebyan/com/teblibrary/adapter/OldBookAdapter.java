 ...
 */
public class OldBookAdapter extends RecyclerView.Adapter<OldBookAdapter.ViewHolder> implements View.OnClickListener {

    public Context context;
    public ArrayList<Metadata> items;

    public OldBookAdapter(Context context, ArrayList<Metadata> items) {
        this.items = items;
        this.context = context;
    }

    @Override
    public OldBookAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_book_row, parent, false);
        return new ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final OldBookAdapter.ViewHolder holder, final int position) {
