...
import library.tebyan.com.teblibrary.fragment.CommentFragment;
import library.tebyan.com.teblibrary.fragment.DetailsFragment;
...
public class DescriptionActivity extends AppCompatActivity {
    ...
    CharSequence[] titles = {"نظرات", "جزییات"};
...
//        initToolbar();
        ViewPager mViewPager = (ViewPager) findViewById(R.id.description_pager);

        tabs = (TabLayout) findViewById(R.id.description_tabs);
