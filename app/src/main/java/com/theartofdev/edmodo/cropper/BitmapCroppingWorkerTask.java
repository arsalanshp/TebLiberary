...
final class BitmapCroppingWorkerTask extends AsyncTask<Void, Void, BitmapCroppingWorkerTask.Result> {
    ...
    public BitmapCroppingWorkerTask(com.theartofdev.edmodo.cropper.CropImageView cropImageView, Bitmap bitmap, float[] cropPoints,
    ...
    public BitmapCroppingWorkerTask(com.theartofdev.edmodo.cropper.CropImageView cropImageView, Uri uri, float[] cropPoints,
