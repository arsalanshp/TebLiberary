...
public class CropImageView extends FrameLayout {
     ...
     */
    private final com.theartofdev.edmodo.cropper.CropOverlayView mCropOverlayView;
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        if (intent != null) {
            options = intent.getParcelableExtra(com.theartofdev.edmodo.cropper.CropImage.CROP_IMAGE_EXTRA_OPTIONS);
        }
        ...
        mCropOverlayView = (com.theartofdev.edmodo.cropper.CropOverlayView) v.findViewById(R.id.CropOverlayView);
        mCropOverlayView.setCropWindowChangeListener(new com.theartofdev.edmodo.cropper.CropOverlayView.CropWindowChangeListener() {
            @Override
