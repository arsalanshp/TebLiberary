...
public class CropImageOptions implements Parcelable {
     ...
     */
    public com.theartofdev.edmodo.cropper.CropImageView.CropShape cropShape;
     ...
     */
    public com.theartofdev.edmodo.cropper.CropImageView.Guidelines guidelines;

    /**
     * The initial scale type of the image in the crop image view
     */
    public com.theartofdev.edmodo.cropper.CropImageView.ScaleType scaleType;
    ...
    public CropImageOptions() {
        ...
        cropShape = com.theartofdev.edmodo.cropper.CropImageView.CropShape.RECTANGLE;
        ...
        guidelines = com.theartofdev.edmodo.cropper.CropImageView.Guidelines.ON_TOUCH;
        scaleType = com.theartofdev.edmodo.cropper.CropImageView.ScaleType.FIT_CENTER;
    ...
    protected CropImageOptions(Parcel in) {
        cropShape = com.theartofdev.edmodo.cropper.CropImageView.CropShape.values()[in.readInt()];
        snapRadius = in.readFloat();
        touchRadius = in.readFloat();
        guidelines = com.theartofdev.edmodo.cropper.CropImageView.Guidelines.values()[in.readInt()];
        scaleType = com.theartofdev.edmodo.cropper.CropImageView.ScaleType.values()[in.readInt()];
